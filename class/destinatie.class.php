...
class codDestinatie {
	...
	public function __construct($connection=null, $iddestinatie="") {
		...
		$stmt = $connection->prepare("SELECT d.idnume, d.numedestinatie FROM nume_destinatie d ORDER BY d.idnume");
		$stmt->execute();
		$stmt->store_result();
	...
	public function get_tipDest(){
	      return $this->results;
	}
	public function get_tipDest_html()
	{
